...
namespace MediaCollection.Migrations
{
    ...
    [Migration("20190930072206_SomeFixesOnSeries")]
    partial class SomeFixesOnSeries
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaCollection.Domain.Aflevering", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MediaCollection.Domain.Seizoen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MediaCollection.Domain.Aflevering", b =>
                {
                    b.HasOne("MediaCollection.Domain.Seizoen")
            ...
            modelBuilder.Entity("MediaCollection.Domain.Seizoen", b =>
                {
                    b.HasOne("MediaCollection.Domain.Serie")
                        .WithMany("Seizoenen")
